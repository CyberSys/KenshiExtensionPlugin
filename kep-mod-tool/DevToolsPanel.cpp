...
bool KEP::tools::DevToolsPanel::initialized()
{
	return _initialized;
}
...
void KEP::tools::DevToolsPanel::_squishTheSelected(DataPanelLine* line)
{
	...
	if (character != nullptr)
	{
		Damages dmg(this->_damageCut, this->_damageBlunt, this->_damagePierce, this->_damageBleedMult, this->_damageArmourPenetration / 100.0f);
